...
import * as middleware from '@google-cloud/logging/build/src/middleware';
import { detectServiceContext } from '@google-cloud/logging/build/src/utils/metadata';
import { CloudLoggingHttpRequest as HttpRequest } from '@google-cloud/logging/build/src/utils/http-request';
export { middleware };
export { HttpRequest };
export { detectServiceContext };
declare const v2: any;
import { Entry, LogEntry } from '@google-cloud/logging/build/src/entry';
import { MonitoredResource, Severity, SeverityNames, formatLogName, assignSeverityToEntries } from '@google-cloud/logging/build/src/utils/log-common';
import { Log, GetEntriesRequest, TailEntriesRequest, LogOptions } from '@google-cloud/logging/build/src/log';
import { LogSync, LogSyncOptions } from '@google-cloud/logging/build/src/log-sync';
import { Sink } from '@google-cloud/logging/build/src/sink';
 ...
 */
export { Logging };
import * as protos from '@google-cloud/logging/build/protos/protos';
export { protos };
export { v2 };
