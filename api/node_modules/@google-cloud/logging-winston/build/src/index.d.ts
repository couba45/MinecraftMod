...
import { LoggingCommon, getCurrentTraceFromAgent } from '@google-cloud/logging-winston/build/src/common';
import * as express from '@google-cloud/logging-winston/build/src/middleware/express';
import { getDefaultMetadataForTracing } from '@google-cloud/logging-winston/build/src/default-metadata';
